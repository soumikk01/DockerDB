    ...
    <section id="features" className="section">
      <div className="container">
        ...
        <div className="bento-grid reveal stagger">
          ...
          <div className="bento-card bento-card--3col">
          ...
          <div className="bento-card bento-card--3col">
            ...
            <div className="card-terminal terminal-cascade reveal">
              <div><span className="syn-dim">$</span> <span className="syn-text">docker ps</span></div>
          ...
          <div className="bento-card bento-card--2col">
            <div className="card-icon card-icon--neutral">
          ...
          <div className="bento-card bento-card--4col">
            <div className="card-wide-inner">
              ...
              <div className="card-wide-content">
                ...
                <div className="card-code-block code-cascade reveal">
                  <div><span className="syn-comment">-- create &amp; query instantly</span></div>
                  <div><span className="syn-keyword">CREATE TABLE</span> <span className="syn-text">posts</span> <span className="syn-dim">(</span></div>
                  <div><span className="syn-dim" style={{ paddingLeft: '1rem' }}>id</span> <span className="syn-muted">SERIAL PRIMARY KEY</span>,</div>
                  <div><span className="syn-dim" style={{ paddingLeft: '1rem' }}>title</span> <span className="syn-muted">VARCHAR(255)</span>,</div>
                  <div><span className="syn-dim" style={{ paddingLeft: '1rem' }}>published</span> <span className="syn-muted">BOOLEAN DEFAULT false</span></div>
